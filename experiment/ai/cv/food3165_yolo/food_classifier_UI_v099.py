...
def main():
    ...
    modelBaseDir = "./yolo"
    modelConfiguration = modelBaseDir + "/config/food3165-yolov3-tiny_3l-v3-2.cfg"
    modelWeights = modelBaseDir + "/data/food/weights/food-dark-yolov3-tiny_3l-v3-2_24000.weights"
    ...
    classesFile = modelBaseDir + "/data/food/food3165-classes.names"
    classes = None
    with open(classesFile, "rt") as f:
        classes = f.read().rstrip("\n").split("\n")

    # path for train
    train_path = glob.glob(r"" + folder_selected)
    # Images path
    images_path = glob.glob(folder_selected + "/*.jpg")
...
btn_execute = Button(
    btn_group_frame, text="Browse and Execute", width=25, style="execute_btn.TButton", command=add_class
)
