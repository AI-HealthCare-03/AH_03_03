"""
당뇨유병 예측 — CatBoost + Optuna + FE (hn18~24 통합) — 나이 5구간화 버전
Python 3.13 | catboost>=1.2 | optuna>=3.0 | scikit-learn>=1.4

FE 조합: 나이_구간5 + BMI구간 + 가족력합산 + BMI_X_나이
나이 구간: 0=19~39 / 1=40~49 / 2=50~59 / 3=60~69 / 4=70세 이상 (단일 컬럼)
...
MODEL_DIR: str = str(
    Path(__file__).parent.parent.parent.parent / "ai_worker" / "ml" / "CAT18~24" / "outputs" / "optuna_DM_FE_v3_age5"
)
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# DM FE 조합 — 나이 5구간 단일 컬럼 버전
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
USE_AGE_BIN5: bool = True  # 나이 5구간 단일 컬럼 (원핫 아님)
