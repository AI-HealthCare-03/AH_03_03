    ...
    with engine.begin() as conn:
        result = conn.execute(
            sql,
            {
                ...
                "rule_outputs": json.dumps(rule_outputs, ensure_ascii=False, default=_json_safe)
                if rule_outputs
                else None,
                "final_outputs": json.dumps(final_outputs, ensure_ascii=False, default=_json_safe)
                if final_outputs
                else None,
                "model_version_info": json.dumps(model_version_info, ensure_ascii=False, default=_json_safe)
