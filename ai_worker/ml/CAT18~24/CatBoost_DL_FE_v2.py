"""
이상지질혈증유병 예측 — CatBoost + FE v2 (hn18~24 통합)
...
MODEL_DIR: str = "/Users/admin/PycharmProjects/AH_03_03/ai_worker/ml/CAT18~24/outputs/catboost_DL_FE_v2"
...
def drop_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    print(f"[v2] 제거된 피처 수: {len(to_drop)}")
