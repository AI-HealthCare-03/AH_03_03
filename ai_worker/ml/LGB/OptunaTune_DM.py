...
Trial 수           : 100 (Fold 불안정 이슈로 HTN/DL보다 많이)
...
MODEL_DIR = os.path.join(BASE_DIR, 'outputs', 'optuna_DM')
...
def objective(trial):
    ...
    # DM 특이사항: Fold Recall 편차 너무 크면 trial 무효
...
best_thr    = best.user_attrs.get('best_thr', 0.30)
...
print(f"[8] Feature Importance Top 15 (gain 평균, 5-fold)")
