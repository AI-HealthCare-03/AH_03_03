"""
이상지질혈증유병 예측 — Optuna 하이퍼파라미터 튜닝 + 피처 엔지니어링 (hn18~24 통합)
...
MODEL_DIR: str = str(Path(__file__).parent.parent.parent.parent / "ai_worker" / "ml" / "LGB18~24" / "outputs" / "optuna_DL_FE_v3")
...
# DL 최적 조합: 나이구간 + BMI구간 + 가족력합산 + BMI_X_나이
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
