...
Optimization Target: OOF F1 최대화  ← [v2 변경] Precision → F1
...
MODEL_DIR: str = str(Path(__file__).parent.parent.parent.parent / "ai_worker" / "ml" / "LGB18~24" / "outputs" / "optuna_HTN_FE_v3")
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# [v2 변경] tune_threshold: Precision 최대화 → F1 최대화
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
def tune_threshold(
    ...
    Returns: (best_thr, best_f1, final_recall, final_precision)
    """
    best_f1: float = 0.0
    best_thr: float = 0.30
    ...
    for thr in THRESHOLD_RANGE:
        ...
        # [v2] Recall 조건 만족 시 F1 최대인 threshold 선택
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# [v2 변경] objective: return best_prec → return best_f1
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
def objective(
    trial: Trial,
    ...
    """
    Optuna objective 함수.
    Recall >= RECALL_MIN 만족 시 OOF F1 최대화.  ← [v2 변경]
    """
    params: dict[str, Any] = {
        "objective": "binary",
        "metric": "auc",
    ...
    trial.set_user_attr("oof_precision", round(oof_prec, 4))  # [v2] precision도 기록
    ...
    # [v2] F1을 반환 → Optuna가 F1 최대화하는 파라미터 탐색
    return best_f1
...
def main() -> None:
    ...
    print(f"    OOF F1        : {best.value:.4f}")  # [v2] Precision → F1
    print(f"    OOF Recall    : {best.user_attrs.get('oof_recall', '-')}")
    print(f"    OOF Precision : {best.user_attrs.get('oof_precision', '-')}")  # [v2] 추가
