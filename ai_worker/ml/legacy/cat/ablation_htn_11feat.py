...
print(
    f"    {'걷기+근력 추가 (11개)':<20} {len(features):>5} {oof_auc:>8.4f} {oof_recall:>8.4f} {oof_f1:>8.4f} {cm[1, 0]:>6}"
)
print(
    f"    변화                 {'':>5} {oof_auc - 0.8580:>+8.4f} {oof_recall - 0.8571:>+8.4f} {oof_f1 - 0.6459:>+8.4f} {cm[1, 0] - 249:>+6}"
)
