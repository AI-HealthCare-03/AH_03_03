"""
당뇨유병 예측 — CatBoost Ablation (검증구조 통일)
Python 3.9 | catboost>=1.2 | scikit-learn>=1.4

피처    : 11개 (근력운동일수까지 제거, ablation 최종)
...
MODEL_DIR = os.path.join(ML_DIR, "outputs", "verif_ablation_cat_DM_11feat")
...
# ablation_dm_11feat.py 최적 파라미터 (그대로 유지)
BEST_PARAMS = dict(
    iterations=899,
