"""
이상지질혈증유병 예측 — CatBoost + Optuna 하이퍼파라미터 튜닝 + FE (hn18~24 통합)
...
MODEL_DIR: str = str(Path(__file__).parent.parent.parent.parent / "ai_worker" / "ml" / "CAT18~24" / "outputs" / "optuna_DL_FE_v3")
