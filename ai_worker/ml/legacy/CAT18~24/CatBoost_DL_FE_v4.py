"""
이상지질혈증유병 예측 — CatBoost + FE v4 (hn18~24 통합)
Python 3.13 | catboost>=1.2 | scikit-learn>=1.4

변경사항 (v4 = v1 베이스라인 + 나이×성별):
...
MODEL_DIR: str = str(Path(__file__).parent.parent.parent.parent / "ai_worker" / "ml" / "CAT18~24" / "outputs" / "catboost_DL_FE_v4")
