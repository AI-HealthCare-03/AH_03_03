"""
이상지질혈증유병 예측 — 피처 정리 버전
Python 3.9 | catboost>=1.2 | scikit-learn>=1.4
제거: 직업 8개 + 고혈압가족력 3개 + 당뇨가족력 3개
사용 피처: 성별, 나이, 키, 체중, BMI, 현재흡연, 고지혈증가족력_부/모/형제,
           걷기일수, 근력운동일수, 과거음주_현재금주, 음주빈도_enc, 음주량_enc
"""
...
MODEL_DIR  = os.path.join(BASE_DIR, 'outputs', 'baseline_hl_slim')
...
print(f"[0] 클래스 분포 | 정상: {neg} / 이상지질혈증: {pos} | ratio: {ratio:.4f}")
