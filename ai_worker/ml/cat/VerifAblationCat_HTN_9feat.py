"""
고혈압유병 예측 — CatBoost Ablation (검증구조 통일)
Python 3.9 | catboost>=1.2 | scikit-learn>=1.4

피처    : 9개 (걷기일수까지 제거, ablation 최종)
...
MODEL_DIR  = os.path.join(ML_DIR, 'outputs', 'verif_ablation_cat_HTN_9feat')
...
# ablation_9feat_HTN.py 최적 파라미터 (그대로 유지)
BEST_PARAMS = dict(
...
print(f"[6] Feature Importance (마지막 fold 기준)")
