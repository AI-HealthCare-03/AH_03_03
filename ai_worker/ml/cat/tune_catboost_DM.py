...
OUTPUT_DIR = os.path.join(BASE_DIR, 'outputs', 'tuned_catboost_DM_100')
...
print(f"[0] 클래스 불균형 | 정상: {neg} / 당뇨: {pos} | ratio: {ratio:.4f}")
...
print(f"    {'피처정리 (14개)':<20} {0.8055:>8.4f} {0.8113:>8.4f} {0.3996:>8.4f} {153:>6}")
print(f"    {'튜닝 후 (14개)':<20} {oof_auc:>8.4f} {oof_recall:>8.4f} {oof_f1:>8.4f} {(y==1).sum() - oof_pred_label[y==1].sum():>6.0f}")
