...
from app.apis.v1.dependencies import ensure_found, get_request_user_with_firebase
...
async def get_user_settings(user: Annotated[User, Depends(get_request_user_with_firebase)]):
...
async def update_user_settings(
    request: UserSettingUpdateRequest, user: Annotated[User, Depends(get_request_user_with_firebase)]
):
