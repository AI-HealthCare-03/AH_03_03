...
async def get_public_main() -> dict:
    return {
...
async def get_login_main_summary(user: User) -> dict:
    ...
    return {
        ...
        "latest_health_summary": latest_health,
...
def _build_today_tasks(user_challenges: list, active_medications: list) -> list[dict]:
    tasks = []
