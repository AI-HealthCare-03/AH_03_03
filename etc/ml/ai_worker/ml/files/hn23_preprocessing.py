"""
hn23_all.sas7bdat 전처리 파이프라인 (성인 한정)
hn24 base_preprocessing.py 구조 기반 · hn23 SAS 포맷 대응
...
INPUT_PATH = os.path.join(BASE_DIR, "data", "hn23_all.sas7bdat")
OUTPUT_PATH = os.path.join(BASE_DIR, "data", "hn23_preprocessed.csv")
