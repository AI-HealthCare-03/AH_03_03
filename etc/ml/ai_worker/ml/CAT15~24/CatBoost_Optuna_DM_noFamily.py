...
MODEL_DIR: str = "/Users/admin/PycharmProjects/AH_03_03/ai_worker/ml/CAT15~24/outputs/optuna_DM_FE_noFamily"
...
def main() -> None:
    ...
    best_params = {
        "iterations":          628,
        "learning_rate":       0.02808976183051849,
        "depth":               6,
        "l2_leaf_reg":         1.3805627297485448,
        "bagging_temperature": 0.39244892276448007,
        "random_strength":     0.6423620561394953,
    }
    ...
    print(f"     Recall 차이 : {test_recall - 0.8528:+.4f}")
    print(f"     F1 차이     : {test_f1 - 0.6009:+.4f}")
    print("\n  → 차이가 크면: 가족력이 주요 원인")
