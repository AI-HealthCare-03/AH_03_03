...
OOF_DIR = os.path.join(BASE_DIR, "outputs", "tuned_catboost_DM")
OUTPUT_DIR = os.path.join(BASE_DIR, "outputs", "threshold_tuning_DM")
...
print(classification_report(y_true, best_pred, target_names=["정상(0)", "당뇨(1)"]))
...
axes[0].set_title("Recall / Precision / F1 vs Threshold (당뇨)")
axes[0].legend()
...
axes[1].set_title("FN / FP vs Threshold (당뇨)")
axes[1].legend()
