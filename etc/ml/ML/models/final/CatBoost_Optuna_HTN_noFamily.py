"""
고혈압유병 예측 — CatBoost + Optuna + FE (hn15~24 통합)
Python 3.13 | catboost>=1.2 | scikit-learn>=1.4 | optuna>=3.0

FE 조합: 나이구간 + 음주위험군 + 걷기활동량 + BMI_X_나이 (가족력 제거)
...
MODEL_DIR: str = "/Users/admin/PycharmProjects/AH_03_03/ai_worker/ml/CAT15~24/outputs/optuna_HTN_FE_noFamily"
