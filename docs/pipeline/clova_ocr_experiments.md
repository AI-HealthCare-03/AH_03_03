...
이 실험은 운영 라우터와 연결하지 않은 독립 PoC입니다. 건강검진표 기본 OCR과 provider 런타임 코드는 `ai_runtime/ocr`에 두고, 과거 실험 스크립트와 샘플 산출물은 `experiment/ai/ocr/providers/clova_ocr` 아래에 archive/reference 용도로 보관합니다.
...
```text
experiment/ai/ocr/providers/clova_ocr/experiments/
...
- `experiment/ai/ocr/providers/clova_ocr/data/pdfs/*`
- `experiment/ai/ocr/providers/clova_ocr/data/images/*`
...
```bash
uv run python experiment/ai/ocr/providers/clova_ocr/experiments/run_clova_ocr_to_txt.py
```
...
```bash
uv run python experiment/ai/ocr/providers/clova_ocr/experiments/run_pdf_vs_image_ocr_compare.py
```
...
```bash
uv run python experiment/ai/ocr/providers/clova_ocr/experiments/run_batch_pdf_vs_image_ocr_compare.py
```
...
```bash
uv run python experiment/ai/ocr/providers/clova_ocr/experiments/debug_raw_json_pages.py
```
...
```bash
uv run python experiment/ai/ocr/providers/clova_ocr/experiments/evaluate_required_fields.py
```
...
```bash
uv run python experiment/ai/ocr/providers/clova_ocr/experiments/export_ground_truth_template.py
```
...
```bash
uv run python experiment/ai/ocr/providers/clova_ocr/experiments/evaluate_value_accuracy.py
```
