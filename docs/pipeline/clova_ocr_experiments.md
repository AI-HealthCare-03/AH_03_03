...
이 실험은 운영 라우터와 연결하지 않은 독립 PoC입니다. 건강검진표 기본 OCR은 `ai_worker/ocr/checkup`에 두고, CLOVA OCR 실험 코드는 `ai_worker/ocr/providers/clova_ocr` 내부에 분리했습니다.
...
- `ai_worker/ocr/providers/clova_ocr/data/pdfs/*`
- `ai_worker/ocr/providers/clova_ocr/data/images/*`
...
```bash
uv run python ai_worker/ocr/providers/clova_ocr/experiments/run_clova_ocr_to_txt.py
```
...
```bash
uv run python ai_worker/ocr/providers/clova_ocr/experiments/run_pdf_vs_image_ocr_compare.py
```
...
```bash
uv run python ai_worker/ocr/providers/clova_ocr/experiments/run_batch_pdf_vs_image_ocr_compare.py
```
...
```bash
uv run python ai_worker/ocr/providers/clova_ocr/experiments/debug_raw_json_pages.py
```
...
```bash
uv run python ai_worker/ocr/providers/clova_ocr/experiments/evaluate_required_fields.py
```
...
```bash
uv run python ai_worker/ocr/providers/clova_ocr/experiments/export_ground_truth_template.py
```
...
```bash
uv run python ai_worker/ocr/providers/clova_ocr/experiments/evaluate_value_accuracy.py
```
