...
from ai_runtime.ml.common.artifacts import save_training_metadata, write_json
from ai_runtime.ml.common.features import apply_feature_engineering
from ai_runtime.ml.common.metrics import evaluate
from ai_runtime.ml.common.threshold import build_threshold_table, tune_threshold
from ai_runtime.ml.datasets.loaders import load_csv_dataset
...
def train_catboost_from_config(
    ...
    *,
    ...
    artifact_dir = Path(str(config.get("artifact_dir") or f"ai_runtime/ml/artifacts/{disease.lower()}/catboost"))
    if dry_run:
        return {
            "status": "dry_run",
            "disease": disease,
