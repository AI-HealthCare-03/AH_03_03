...
function formFromRecord(
  ...
  return {
    ...
    drinking_amount: toStringValue(record?.drinking_amount) || (record?.drinks_alcohol ? "THREE_TO_SIX" : ""),
    walking_days: toStringValue(record?.walking_days_per_week ?? record?.exercise_days_per_week),
